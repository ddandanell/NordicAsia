...
export function Hero() {
  return (
    ...
    >
      ...
      >
        <div className="container mx-auto px-4 py-4 flex items-center justify-center gap-8 md:gap-16">
          {[
            ...
            <div key={label} className="text-center">
              ...
              <p className="text-[10px] md:text-xs text-white/60 uppercase tracking-wider">{label}</p>
            </div>
          ))}
        </div>
      </motion.div>
