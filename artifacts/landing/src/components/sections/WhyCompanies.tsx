            ...
            return (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="mt-4 pt-3 border-t border-border/40 text-[10px] text-muted-foreground/70 italic leading-snug">
                    This is just a little part of who is supporting us.
                  </p>
                </div>
              </motion.div>
            );
