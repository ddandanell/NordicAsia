      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          >
            ...
            <br className="hidden md:block" /> your life and business here.
          </h2>
          <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
            Inside the community you get access to real people, real knowledge, and real
            opportunities. Here is what members use every day.
          </p>
        </motion.div>
