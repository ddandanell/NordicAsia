  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto relative z-10 text-center max-w-3xl">
        ...
        >
          <h2
            className="text-3xl md:text-5xl font-bold mb-5 text-white tracking-tight leading-snug"
            data-testid="heading-cta"
          >
            Join the Community
          </h2>
          <p
            className="text-base md:text-lg text-white/80 mb-3 leading-relaxed max-w-2xl mx-auto"
            data-testid="text-cta-desc"
          >
            Meet people. Join groups. Explore events. Build real connections
            across Bali, Jakarta, and beyond.
          </p>
          <p className="text-sm text-white/60 mb-10 font-medium tracking-wide">
            Powered by WhatsApp. Your first event is free.
          </p>
